...
export type BlockType = "text" | "video" | "sheet_music" | "audio"
...
export function AddContentSidebar({ isOpen, onClose, onAddBlock, isAdding }: AddContentSidebarProps) {
