...
export function StudioHeader({ onSave, isSaving, onToggleSidebar, isSidebarOpen }: StudioHeaderProps) {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground">Editing: Introduction to Music Theory</p>
          </div>
        </div>
      </div>
