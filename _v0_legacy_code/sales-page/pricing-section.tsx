            ...
            >
              ...
              <div className="text-center mb-8 pt-2">
                ...
                <div className="flex items-baseline justify-center gap-1">
                  <span
                    className={`text-5xl font-bold ${plan.featured ? "text-daw-purple glow-text-purple" : "text-foreground"}`}
                  >
                    {plan.price}
                  </span>
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <div
                      className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                        plan.featured ? "bg-daw-purple/20" : "bg-secondary"
                      }`}
                    >
                      <Check className={`w-3 h-3 ${plan.featured ? "text-daw-purple" : "text-daw-cyan"}`} />
                    </div>
              ...
              >
                {plan.featured ? "Get Lifetime Access" : "Start Monthly"}
              </Button>
